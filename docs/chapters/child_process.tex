...
\lstinputlisting[caption={\textit{The PID of a child process is written to the console}},label={001_pid.js}]{../src/child_process/001_pid.js}
...
\lstinputlisting[caption={\textit{A child process is terminated by the default signal \texttt{SIGTERM}}},label={002_kill_default.js}]{../src/child_process/002_kill_default.js}
...
\lstinputlisting[caption={\textit{A child process is terminated by signal \texttt{SIGHUP}}},label={002_kill_sighup.js}]{../src/child_process/002_kill_sighup.js}
...
\lstinputlisting[caption={\textit{An invalid signal \texttt{NOOP} is sent to a child process}},label={002_kill_noop.js}]{../src/child_process/002_kill_noop.js}
Finally if \texttt{child.kill()} is not called and a child process exits gracefully, a \texttt{null} signal is expected. It is verified by the code in Listing \ref{listing_finish_null_signal}. \lstinputlisting[caption={\textit{No signal is sent to a child process and it exits cleanly}},label={002_finish_null_signal.js}]{../src/child_process/002_finish_null_signal.js}
...
\lstinputlisting[caption={\textit{Spawn a new process to list files under the current directory}},label={003_spawn_simple.js}]{../src/child_process/003_spawn_simple.js}
